...
#if !defined(__array_SimpleMultiIndexExtentsIterator_ipp__)
...
calculateIndexList() {
#ifdef DEBUG_stlib
   assert(_rank <= Index(product(_extents)));
#endif
   // Column-major.
   // The strides.
   IndexList strides;
