...
isVolatile(const std::size_t index) {
   typedef typename array::SparseVector<std::size_t>::const_iterator
   const_iterator;

   // For each reactant.
   const array::SparseVector<std::size_t>& reactants =
   ...
   // For each product.
   const array::SparseVector<std::size_t>& products =
