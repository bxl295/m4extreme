...
#include "HistogramsBase.h"
#include "TimeEpochOffset.h"

#include "../numerical/random/hypoexponential/HypoexponentialDistributionDistinctDynamicMinimumParameters.h"
...
private:
   ...
   HomogeneousHistogramsTransientDirectTreeHypoexponentialLimit(const HomogeneousHistogramsTransientDirectTreeHypoexponentialLimit&);
