...
private:
   ...
   */
   ...
   computePropensities(const std::vector<double>& populations,
      ...
      _computePropensities(Loki::Int2Type<_IsInhomogenous>(), populations,
                           timeOffset);
   }

   void
   _computePropensities(Loki::Int2Type<false> /*IsInhomogeneous*/,
                        const std::vector<double>& populations,
                        const double /*timeOffset*/);

   void
   _computePropensities(Loki::Int2Type<true> /*IsInhomogeneous*/,
                        const std::vector<double>& populations,
                        const double timeOffset);
