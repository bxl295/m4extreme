...
#include "DgPmfOrderedPairPointer.h"
...
public:
   ...
   static const bool AutomaticUpdate = false;
...
private:
   ...
   const array::StaticArrayOfArrays<std::size_t>* _influence;
...
public:
   ...
   (DiscreteUniformGenerator* generator,
    const array::StaticArrayOfArrays<std::size_t>* influence,
...
public:
   ...
   */
   ...
   void
   setInfluence(const array::StaticArrayOfArrays<std::size_t>* influence) {
      _influence = influence;
   }
