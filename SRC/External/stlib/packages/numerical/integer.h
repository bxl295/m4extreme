...
#include "integer/bits.h"
#include "integer/print.h"
...
/*!
  ...
  - You may choose an integer type with at least a specified number of bits
  using IntegerWithAtLeastSpecifiedBits and
  UnsignedIntegerWithAtLeastSpecifiedBits .
